...
Agent(
  prompt: "
    ...
    Follow ALL instructions in .claude/skills/sdlc-code-research.md
...
Agent(
  prompt: "
    ...
    Follow ALL instructions in .claude/agents/sdlc-architect.md
...
Agent(
  prompt: "
    ...
    Follow ALL instructions in .claude/skills/sdlc-solution-planning.md
...
Agent(  ← Security reviewer
  prompt: "
    ...
    Follow ALL instructions in .claude/agents/sdlc-security-reviewer.md
...
Agent(  ← QA reviewer (parallel with security)
  prompt: "
    ...
    Follow ALL instructions in .claude/agents/sdlc-qa-reviewer.md
...
Agent(  ← SRE reviewer (parallel with security and QA)
  prompt: "
    ...
    Follow ALL instructions in .claude/agents/sdlc-sre-reviewer.md
...
Agent(
  prompt: "
    ...
    Follow ALL instructions in .claude/skills/sdlc-review-fix.md
...
```
# If security failed:
Agent("Execute Security Review for {issue_name}. Follow .claude/agents/sdlc-security-reviewer.md.
...
# If QA failed:
Agent("Execute QA Review for {issue_name}. Follow .claude/agents/sdlc-qa-reviewer.md.
...
# If SRE failed:
Agent("Execute SRE Review for {issue_name}. Follow .claude/agents/sdlc-sre-reviewer.md.
...
Agent(
  prompt: "
    ...
    Follow ALL instructions in .claude/agents/sdlc-tech-writer.md
