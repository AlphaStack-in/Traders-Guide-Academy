...
function runBuildChangelogTests() {
  ...
  console.assert(pkg.version === "1.0.4", `FAIL: Expected package.json version 1.0.4, got ${pkg.version}`);
  ...
  console.assert(info.version === "1.0.4", `FAIL: Expected version 1.0.4, got ${info.version}`);
