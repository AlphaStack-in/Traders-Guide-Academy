...
function runBuildChangelogTests() {
  ...
  console.assert(pkg.version === "1.0.5", `FAIL: Expected package.json version 1.0.5, got ${pkg.version}`);
  ...
  console.assert(info.version === "1.0.5", `FAIL: Expected version 1.0.5, got ${info.version}`);
