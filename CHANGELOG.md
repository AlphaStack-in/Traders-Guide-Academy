...
### Changed
- Navbar logo styling improved: replaced white background with subtle semi-transparent border for better contrast with light-color logo on dark background
