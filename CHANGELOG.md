...
### Changed
- **Home** — Explore Flagship Products section redesigned (layout, copy, and `exploreProducts` config)
- **Home** — testimonials and Instagram video grid restored to horizontal scrolling marquees
